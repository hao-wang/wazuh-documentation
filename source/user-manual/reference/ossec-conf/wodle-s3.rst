...
+----------------------------------+-------------------------------------------------------------+-----------------------------------------------+
| `bucket\\role_session_duration`_ | A number of seconds between 900 and 43200                   | Optional (if set, it requires an iam_role_arn |
|                                  |                                                             | to be provided)                               |
+----------------------------------+-------------------------------------------------------------+-----------------------------------------------+
...
| **Default value**  | N/A                           |
+--------------------+-------------------------------+
| **Allowed values** | Numbers between 900 and 43200 |
+--------------------+-------------------------------+
